...
namespace Joy\VoyagerBreadRelatable\Models;
...
use Joy\VoyagerBreadRelatable\Database\Factories\RelatableFactory;
...
class Relatable extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('Relatable'));
    }
